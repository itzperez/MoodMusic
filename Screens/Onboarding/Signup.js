...
export default function Signup({ callbackOnboardingStack }) {
  ...
  if (!readDescription) {
    contentDisplayed = (<Onboarding backgroundImage={require('../../assets/Images/mountain-background.jpg')} pages={pages} />)
  } else {
    contentDisplayed = (
      <View style={styles.container}>
        <View style={{ flex: .15, flexDirection: 'row', width: '100%' }}>
        ...
        <View style={{ flex: .4, width: '100%', justifyContent: 'space-evenly', alignItems: 'center' }}>
          <TextInput
            style={styles.input}
            autoCapitalize='none'
